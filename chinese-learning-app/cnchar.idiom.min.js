!function(n, i) {
    "object" == typeof exports && "object" == typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define([], i) : "object" == typeof exports ? exports.cncharIdiom = i() : n.cncharIdiom = i()
}(this, (function() {
    return function(n) {
        var i = {};
        function u(g) {
            ...
            return n[g].call(h.exports, h, h.exports, u),
            h.l = !0,
            h.exports
        }
        return u.m = n,
        u.c = i,
        u.d = function(n, i, g) {
            u.o(n, i) || Object.defineProperty(n, i, {
                enumerable: !0,
                get: g
            })
        }
    ...
    , function(n, i, u) {
        ...
        var a, e = function(n) {
            var i;
            return 1 === n.length ? !!n.match(/[\u4e00-\u9fa5]/) : (null === (i = n.match(/[\u4e00-\u9fa5]/g)) || void 0 === i ? void 0 : i.join("").length) === n.length
        };
        function t(n) {
            return "string" == typeof n && (n = n.split("")),
            g.a.filter((function(i) {
                return c(n, i.split(""))
            }
            ))
        }
        ...
        var s = Object.assign((function(n, i) {
            if (!n)
                return console.warn("idiom: 请输入搜索项"),
                [];
            if (i || (i = function n(i) {
                if ("number" == typeof i)
                    return "stroke";
                if ("string" == typeof i)
                    return e(i) ? "char" : function(n) {
            ...
            ("spell" === i || "tone" === i) && "string" != typeof n)
                return console.warn("idiom spell 模式下仅支持查询首个汉字的拼音"),
                [];
            var u = null;
            return a ? u = "spell" === i || "tone" === i ? function(n, i) {
                var u = g.a.length
                  , e = i ? h.a : o.a;
                i && (n = a._.transformTone(n, !0).spell);
                ...
                return t.forEach((function(n) {
                    var i = e.indexOf(n)
                      , h = parseInt(n.split(":")[1])
                      , o = i === s ? u : parseInt(e[i + 1].split(":")[1]);
                    c = c.concat(g.a.slice(h, o))
                }
                )),
                c
            }(n, "tone" === i) : "stroke" === i ? function(n) {
                if ("number" == typeof n)
                    return g.a.filter((function(i) {
                        return n === a.stroke(i)
                    }
                    ));
                return g.a.filter((function(i) {
                    return c(n, a.stroke(i, "array"))
                }
                ))
            }(n) : t(n) : (u = t(n),
            "char" !== i && console.warn("未引入cnchar,idiom只支持汉字查询")),
            u
        }
        ), {
            pluginName: "idiom",
        ...
        "object" == typeof window && (window.CncharIdiom = s,
        window.CnChar && window.CnChar.use(s));
        i.default = s
    }
    ]).default
}
