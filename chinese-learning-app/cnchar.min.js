!function(n, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.cnchar = e() : n.cnchar = e()
}(this, (function() {
    return function(n) {
        var e = {};
        function r(o) {
            ...
            return n[o].call(t.exports, t, t.exports, r),
            t.l = !0,
            t.exports
        }
        return r.m = n,
    ...
    , function(n, e, r) {
        ...
        var o, t = {
            ...
            var e = t.info.initial;
            n = n.toLowerCase();
            var r = o.removeTone(n, !1);
            if (-1 === r.index) {
                if (!t.spell[r.spell])
                    throw new Error("【spellInfo】错误的拼音: " + n + ", 请检查字符是否正确");
                r.index = parseInt(t.spell[r.spell][0]) + 1
            }
            for (var i = "", a = r.spell, u = 0; u < e.length; u++)
                if (0 === r.spell.indexOf(e[u])) {
                    i = e[u],
                    a = r.spell.substr(i.length);
                    break
                }
            return {
                spell: r.spell,
        ...
        function l() {
            for (var n = [], e = 0; e < arguments.length; e++)
                n[e] = arguments[e];
            console.warn.apply(console, u(["CnChar Warning:"], n))
        }
        var s = function(n, e, r) {
            if ("object" != typeof n)
                r(n, e);
            else
                for (var o in n)
        ...
        function f(n, e) {
            ...
            for (var r = [], o = n.length, t = []; t.length < e; ) {
                var i = p(0, o - 1);
        ...
        function p(n, e) {
            return n + Math.round(Math.random() * (e - n))
        }
        var h = function(n) {
            var e;
            return 1 === n.length ? !!n.match(/[\u4e00-\u9fa5]/) : (null === (e = n.match(/[\u4e00-\u9fa5]/g)) || void 0 === e ? void 0 : e.join("").length) === n.length
        };
        var d = function(n, e) {
            return -1 !== n.indexOf(e)
        };
        var g, v = "āáǎàōóǒòēéěèīíǐìūúǔùǖǘǚǜ*ńňǹ", y = {
            array: "array",
            low: "low",
            up: "up",
            first: "first",
        ...
        function x(n, e) {
            ...
            var i = d(o, y.poly)
              ...
              , u = [];
            for (var l in n)
                for (var s = n[l], f = parseInt(s[0]), c = function(n) {
                    var e = r[n]
                      , o = function(r) {
                        C(e, r) ? u[n].unshift(r) : u[n].push(r)
                    };
                    if (h(e)) {
                        var c = s.indexOf(e);
                        if (-1 !== c) {
                            ...
                            if (p.poly) {
                                u[n] || (u[n] = []),
                                o(p.res);
                                for (var d = s, g = d.match(new RegExp(e,"g")).length, v = 1; v < g; v++)
                                    c = (d = d.substr(c + 2)).indexOf(e),
                                    o(T(l, d, c, i, a, f).res)
                            } else
                                p.isPolyWord && t.spellDefault[e] && (p.res = S(t.spellDefault[e], a).spell),
                                u[n] = [p.res],
                                r[n] = ""
                        }
                    } else
            ...
            for (p = 0; p < r.length; p++) {
                var v = u[p];
                void 0 === v ? g[p] = r[p] : v.length > 1 ? "NOT_CNCHAR" === v[0] ? g[p] = v[1] : g[p] = "(" + v.join("|") + ")" : g[p] = v[0],
                d(o, y.flat) && d(o, y.tone) && (g[p] = P(g[p], !0))
            }
            return d(o, y.array) ? g : g.join("")
        }
        var w = function(n, e) {
            g._.poly && k(n, O),
            d(e, y.first) && k(n, b),
            d(e, y.up) ? k(n, j) : d(e, y.low) || k(n, z)
        };
        function k(n, e) {
            n.forEach((function(r, o) {
                "string" != typeof r ? "NOT_CNCHAR" !== r[0] && r.forEach((function(n, o) {
                    r[o] = e(n)
                }
                )) : n[o] = e(r)
            }
        ...
        function z(n) {
            return j(n[0]) + n.substr(1)
        }
        function O(n) {
            return n.toLowerCase()
        }
        function T(n, e, r, o, t, i) {
            ...
            return o || t ? (u.isPolyWord && (a -= 5,
            o && (u.poly = !0)),
            t && (u.res = _(n, i, a)),
            u) : u
        }
        function C(n, e) {
            var r = t.spellDefault[n];
            return !!r && (r === e || P(r, !0).replace(/[0-4]/, "") === e)
        }
        var S = function(n, e) {
            if (e)
                return {
            ...
            for (var r = 0; r < n.length; r++) {
                ...
                if (-1 !== o)
                    return {
                        spell: n.substr(0, r) + "aoeiuün"[Math.floor(o / 4)] + n.substr(r + 1),
                        tone: o % 4 + 1,
                        index: r + 1
                    }
            }
        ...
        function _(n, e, r) {
            if (0 === r)
                return n;
            var o = n[e]
              , t = v[4 * "aoeiuün".indexOf(o) + (r - 1)];
            return o !== t ? n.replace(o, t) : n
        }
        function q(n, e) {
            var r = e[0].split("")
              , o = []
              , t = e.splice(1);
            for (var i in E("stroke", t),
            n)
                for (var a = 0; a < r.length; a++)
                    r[a] && -1 !== n[i].indexOf(r[a]) && (r[a] = "",
                    o[a] = parseInt(i));
          ...
          , E = function(n, e, r) {
            if (g.check)
                if (A)
                    ...
                    -1 === g.plugins.indexOf("trad") && (d(e, "simple") && a.push("simple"),
                    d(e, "trad") && a.push("trad")),
                    "spell" === n ? d(e, "up") && d(e, "low") && a.push("low") : "stroke" === n ? d(e, "order") ? (l("array", u),
                    d(e, "letter") ? (l(["detail", "shape", "name", "count"]),
                    l("letter", u)) : d(e, "detail") ? l(["shape", "name", "count"]) : d(e, "shape") ? l(["name", "count"]) : d(e, "name") && l(["count"])) : (l(["detail", "shape", "name", "letter"]),
                    l("count", u)) : "orderToWord" === n ? d(e, "match") ? l(["matchorder", "contain", "start"]) : d(e, "matchorder") ? l(["contain", "start"]) : d(e, "contain") && l(["start"]) : "strokeToWord" === n || "spellToWord" === n || "idiom" === n && (d(e, "spell") ? l(["stroke", "char"]) : d(e, "stroke") ? l(["tone", "char"]) : l(["tone"])),
                    N(o, "无效", n, e),
                    N(a, "被忽略", n, e),
                    N(u, "冗余", n, e)
                }
        ...
        function N(n, e, r, o) {
            if (n.length > 0) {
                var t = "以下参数" + e + ":" + JSON.stringify(n) + ";";
                "被忽略" !== e || "stroke" !== r || d(o, "order") ? t += " 可选值：[" + Object.keys(g.type[r]) + "]" : t += " 要启用笔顺模式必须使用 order 参数",
                l(t)
            }
        }
        function P(n, e) {
            void 0 === e && (e = !1);
            var r = -1 !== "01234".indexOf(n[n.length - 1]);
            if (!e)
                return r ? I(n, !0, "low").spell : n;
            if (r)
                return n;
            var o = I(n, !1, "low");
            return -1 !== o.spell.indexOf("ü") && (o.spell = o.spell.replace("ü", "v")),
            r ? n : o.spell + o.tone
        }
        var I = function(n, e, r) {
            void 0 === e && (e = !1),
            void 0 === r && (r = "low"),
            -1 !== n.indexOf("v") && (n = n.replace("v", "ü"));
            var o, t, i = n[n.length - 1], u = -1, l = !1;
            parseInt(i).toString() === i ? (n = n.substr(0, n.length - 1),
            u = (t = a(n)).index,
            o = parseInt(i),
            l = !0,
            e && (n = _(n, u - 1, o))) : (u = (t = a(n)).index,
            o = t.tone,
            e || 0 === o || (n = t.spell));
            return "low" === r ? n = n.toLowerCase() : "up" === r && (n = n.toUpperCase()),
            {
                spell: n,
                tone: o,
                index: u,
                ...
                if (o instanceof Array)
                    ...
                    if ((e = e).length >= 1) {
                        for (var l = 0; l < e.length; l++) {
                            var s = e[l];
                            if (s.spell === a.spell && s.tone === a.tone)
                                return
                        }
                        i || (i = !0)
                    }
                    var f = "" + r + (a.tone + (i ? 5 : 0));
                    if (n[a.spell] = u ? u + f : a.index + ":" + f,
                    1 === e.length) {
                        var c = e[0];
                        n[c.spell] = n[c.spell].replace("" + r + c.tone, "" + r + (c.tone + 5))
                    }
                    i && function(n) {
                        -1 === t.info.polyWord.indexOf(n) && (t.info.polyWord += n)
                    }(r)
                }
            else
                for (var p in r)
        ...
        function D(n, e) {
            var r = x(n, [e, y.tone, y.poly]);
            return r === e ? [] : (-1 !== r.indexOf("|") ? r.substring(1, r.length - 1).split("|") : [r]).map((function(n) {
                return I(n)
            }
            ))
        }
        ...
        function U(n) {
            ...
            J.checkArgs("strokeToWord", e);
            var o = ""
              , i = {
                simple: J.has(e, H.simple),
                trad: J.has(e, H.trad)
            };
            return i.simple || i.trad || (i.simple = i.trad = !0),
            i.simple && (o += B(n, t.stroke)),
            i.trad && J.dict.getTradCount && (o += B(n, J.dict.getTradCount())),
            J.has(e, H.array) ? o.split("") : o
        }
        function B(n, e) {
        ...
        function X(n, e) {
            ...
            var r = function(n) {
                var e = L._.tones.indexOf(n);
                return -1 === e ? -1 : F[e]
            }(n);
            return -1 === r ? n.charCodeAt(0) : r
        }
        var Y, Z = function() {
            for (var n = 0, e = 0, r = arguments.length; e < r; e++)
                n += arguments[e].length;
        ...
        function K(n) {
            ...
            function(n) {
                L = n,
                "aoeiuvn".split("").forEach((function(n) {
                    for (var e = n.charCodeAt(0), r = 1; r <= 4; r++)
                        F.push(e + .1 * r)
                }
                ))
            }(n)
        ...
        function en(n, e) {
            ...
            if (e && r.push("tone"),
            Y.isCnChar(n))
                return Y.spell.apply(Y, Z([n], r));
            try {
                return Y._.transformTone(n, e).spell
            } catch (n) {
        ...
        function rn(n, e, r) {
            ...
            return n.length === e.length ? nn : V
        }
        function on(n, e) {
            return "string" == typeof n && (n = Y.stroke(n)),
            "string" == typeof e && (e = Y.stroke(e)),
            n > e ? Q : n < e ? V : nn
        }
        var tn = function(n) {
            var e = function() {
            ...
            return e.__default = !0,
            e
        }
          , an = [];
        function un(n) {
            return -1 === an.indexOf(n) && (an.push(n),
            !0)
        }
        var ln = "";
        var sn = "object" == typeof wx && "object" == typeof __wxConfig ? "miniapp" : "object" == typeof window ? "web" : "node"
          , fn = function() {
            return (fn = Object.assign || function(n) {
                for (var e, r = 1, o = arguments.length; r < o; r++)
                    for (var t in e = arguments[r])
        ...
        var dn, gn, vn, yn, mn, xn = fn(fn({
            ...
            _: {
                ...
                dict: {},
                mapJson: s,
                checkTrad: function(n, e) {
                    if (-1 === e.indexOf("trad") || -1 === g.plugins.indexOf("trad"))
                        return n;
                    var r = !1;
                    return n instanceof Array && (r = !0,
                    n = n.join("")),
                    n = g.convert.tradToSimple(n),
                    r ? n.split("") : n
                },
            ...
            sortSpell: function(n) {
                ...
                var t = -1 !== e.indexOf($)
                  ...
                  , a = i ? -1 : 1
                  , u = -1 * a
                  , l = n.sort((function(n, e) {
                    var r = rn(n, e, t);
                    return r === Q ? a : r === V ? u : 0
                }
                ));
                return o ? l.join("") : l
            },
            sortStroke: function(n, e) {
                var r = !1;
                "string" == typeof n && (n = n.split(""),
                r = !0);
                var o = e === G ? -1 : 1
                  , t = -1 * o
                  , i = n.sort((function(n, e) {
                    var r = on(n, e);
                    return r === Q ? o : r === V ? t : 0
                }
                ));
                return r ? i.join("") : i
            },
            setSpellDefault: function(n, e) {
                R({
                    target: t.spellDefault,
                    key: n,
                    value: e,
                    isSpell: !0
                })
            },
            setSpell: function(n, e) {
                !function(n, e, r) {
                    var o;
                    if ("object" == typeof e)
                        for (var t in o = {},
            ...
            isPolyWord: function(n) {
                return "" !== n && (n.length > 1 && (n = n[0]),
                !!h(n) && -1 !== t.info.polyWord.indexOf(n))
            },
            shapeSpell: P,
            hasTone: function(n) {
            ...
            spellToWord: function() {
                ...
                var a = o.transformTone(r, !1)
                  , u = n.splice(1);
                o.checkArgs("spellToWord", u);
                var l = {
                    simple: o.has(u, i.simple),
                    trad: o.has(u, i.trad),
                    poly: o.has(u, i.poly),
                    alltone: o.has(u, i.alltone)
                };
                l.simple || l.trad || (l.simple = l.trad = !0);
                for (var s = "", f = t.spell[a.spell].substr(2), c = 0; c < f.length; c += 2) {
                    var p = f[c]
                      , h = parseInt(f[c + 1])
                      , d = h > 4;
                    d && (h -= 5),
                    -1 !== s.indexOf(p) || !l.alltone && h !== a.tone || l.poly && !d || (s += p)
                }
                if (l.trad && o.convert) {
                    var g = "";
                    for (c = 0; c < s.length; c++) {
                        var v = o.convert.simpleToTrad(s[c]);
                        v !== s[c] && (g += v)
                    }
                    l.simple ? s += g : s = g
                }
                return o.has(u, i.array) ? s.split("") : s
            },
            strokeToWord: U,
            spellInfo: a,
            setResourceBase: function(n) {
                ...
                this.plugins.forEach((function(n) {
                    var r, o = e[n];
                    o && (null === (r = o._refreshResource) || void 0 === r || r.call(o, e))
                }
                ))
            }
        }, (dn = tn("draw"),
        ...
        vn = tn("radical"),
        yn = tn("xhy"),
        "object" == typeof window && (window.CncharIdiom = gn,
        window.CncharDraw = dn,
        window.CncharRadical = vn,
        window.CncharXHY = yn),
        {
            idiom: gn,
            draw: dn,
        ...
        String.prototype.spell = function() {
            for (var n = [], e = 0; e < arguments.length; e++)
                n[e] = arguments[e];
            return pn.apply(void 0, cn([this], n))
        }
        ,
        String.prototype.stroke = function() {
            for (var n = [], e = 0; e < arguments.length; e++)
                n[e] = arguments[e];
            return hn.apply(void 0, cn([this], n))
        }
        ,
        g = xn,
        o = (mn = xn)._,
        a.tones = o.tones.split(""),
        a.initials = t.info.initial,
        mn.spellInfo = a,
        mn.type.spellToWord = i,
        function(n) {
            n.strokeToWord = U,
            n.type.strokeToWord = H,
            J = n._
        }(xn),
        K(xn),
        "undefined" != typeof window && (window.cnchar = window.CnChar = xn);
        e.default = xn
    }
    ]).default
}
