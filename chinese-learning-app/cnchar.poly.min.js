!function(n, h) {
    "object" == typeof exports && "object" == typeof module ? module.exports = h() : "function" == typeof define && define.amd ? define([], h) : "object" == typeof exports ? exports.cncharPoly = h() : n.cncharPoly = h()
}(this, (function() {
    return function(n) {
        var h = {};
        function g(i) {
            ...
            return n[i].call(u.exports, u, u.exports, g),
            u.l = !0,
            u.exports
        }
        return g.m = n,
        g.c = h,
        g.d = function(n, h, i) {
            g.o(n, h) || Object.defineProperty(n, h, {
                enumerable: !0,
                get: i
            })
        }
        ...
        g.t = function(n, h) {
            ...
            8 & h)
                return n;
            if (4 & h && "object" == typeof n && n && n.__esModule)
                return n;
    ...
    , function(n, h, g) {
        "use strict";
        g.r(h);
        var i, u, s, o = g(0), c = function() {
            for (var n = 0, h = 0, g = arguments.length; h < g; h++)
                n += arguments[h].length;
            var i = Array(n)
              , u = 0;
            for (h = 0; h < g; h++)
                for (var s = arguments[h], o = 0, c = s.length; o < c; o++,
                u++)
                    i[u] = s[o];
            return i
        }, z = o, j = "poly";
        function l(n) {
            for (var h = [], g = 1; g < arguments.length; g++)
                h[g - 1] = arguments[g];
            if (u.checkArgs("spell", h, !0),
            u.has(h, u.arg.poly))
                return s.apply(void 0, c([n], h));
            var i = [u.arg.array];
            h.forEach((function(n) {
                "first" !== n && "up" !== n && "low" !== n && i.push(n)
            }
            ));
            var o = u.has(h, u.arg.tone)
              , j = s.apply(void 0, c([n], i));
            for (var l in z) {
                var y = n.indexOf(l);
                if (-1 !== y)
                    for (var d = z[l].split(" "), b = 0; b < d.length; b++)
                        j[y + b] = u.removeTone(d[b], o).spell
            }
            return u.dealUpLowFirst(j, h),
            u.has(h, u.arg.array) ? j : j.join("")
        }
        var y = function(n, h) {
            if ("object" != typeof n)
                "string" == typeof h && (z[n] = h.split(" ").map((function(n) {
        ...
        var d = {
            ...
            install: function(n) {
                ...
                var h = function(n) {
                    for (var h = [], g = 1; g < arguments.length; g++)
                        h[g - 1] = arguments[g];
                    return u.has(h, j) ? s.apply(void 0, c([n], h)) : l.apply(void 0, c([n], h))
                };
                n.spell = h,
                String.prototype.spell = function() {
                    for (var n = [], g = 0; g < arguments.length; g++)
                        n[g] = arguments[g];
                    return h.apply(void 0, c([this], n))
                }
                ,
                n._.poly = !0,
                n._._reinitSpellPoly && (n._._reinitSpellPoly(),
                delete n._._reinitSpellPoly)
            },
            setPolyPhrase: y,
            dict: {
                phrases: z
        ...
        "object" == typeof window && window.CnChar && (window.CncharPoly = d,
        window.CnChar.use(d)),
        h.default = d
    }
    ]).default
