!function(j, f) {
    "object" == typeof exports && "object" == typeof module ? module.exports = f() : "function" == typeof define && define.amd ? define([], f) : "object" == typeof exports ? exports.cncharTrad = f() : j.cncharTrad = f()
}(this, (function() {
    return function(j) {
        var f = {};
        function c(k) {
            ...
            return j[k].call(s.exports, s, s.exports, c),
            s.l = !0,
            s.exports
        }
        return c.m = j,
        c.c = f,
        c.d = function(j, f, k) {
            c.o(j, f) || Object.defineProperty(j, f, {
                enumerable: !0,
                get: k
            })
        }
        ,
        c.r = function(j) {
            "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(j, Symbol.toStringTag, {
                value: "Module"
            }),
        ...
        c.t = function(j, f) {
            ...
            8 & f)
                return j;
            if (4 & f && "object" == typeof j && j && j.__esModule)
                return j;
        ...
        ,
        c.o = function(j, f) {
            return Object.prototype.hasOwnProperty.call(j, f)
        }
        ,
        c.p = "",
        c(c.s = 8)
    ...
    , function(j, f, c) {
        ...
        function e(j, f, c) {
            if (void 0 === f || !T[f])
                throw new Error("convert 参数类型错误： to=" + f);
            if (void 0 === c || !T[c])
                throw new Error("convert 参数类型错误： from=" + c);
            var k = ""
              , s = "";
            if (f === T.simple)
                c === T.trad ? (k = O.simple,
                ...
                if (c !== T.simple)
                    return e(e(j, T.simple, T.spark), T.trad, T.simple);
                k = O.trad,
                s = O.simple
            } else {
                if (c === T.trad)
                    return e(e(j, T.simple, T.trad), T.spark, T.simple);
                k = W.spark,
                s = W.simple
            }
            for (var a = "", d = 0; d < j.length; d++) {
                var Y = s.indexOf(j[d]);
                a += -1 !== Y ? k[Y] : j[d]
            }
            return a
        ...
        var r, N = {
            type: T,
            simpleToTrad: function(j) {
                return e(j, T.trad, T.simple)
            },
            simpleToSpark: function(j) {
                return e(j, T.spark, T.simple)
            },
            tradToSimple: function(j) {
                return e(j, T.simple, T.trad)
            },
            tradToSpark: function(j) {
                return e(j, T.spark, T.trad)
            },
            sparkToSimple: function(j) {
                return e(j, T.simple, T.spark)
            },
            sparkToTrad: function(j) {
                return e(j, T.trad, T.spark)
            }
        }, C = function() {
            for (var j = 0, f = 0, c = arguments.length; f < c; f++)
                j += arguments[f].length;
            var k = Array(j)
              , s = 0;
            for (f = 0; f < c; f++)
                for (var a = arguments[f], d = 0, Y = a.length; d < Y; d++,
                s++)
                    k[s] = a[d];
            return k
        ...
        var B = {
            ...
            install: function(j) {
                ...
                "object" == typeof j.type.spell && (j.type.spell.simple = R,
                j.type.spell.trad = Q),
                "object" == typeof j.type.stroke && (j.type.stroke.simple = R,
                j.type.stroke.trad = Q),
                function(j, f) {
                    var c = f.spell
                      , k = function(j) {
                        for (var f = [], k = 1; k < arguments.length; k++)
                            f[k - 1] = arguments[k];
                        if (r.has(f, R))
                            return c.apply(void 0, C([j], f));
                        if (r.has(f, Q)) {
                            var s = r.has(f, n);
                            s || f.push(n);
                            for (var a = N.tradToSimple(j), d = [], Y = "", M = 0; M < a.length; M++)
                                a[M] !== j[M] ? Y += a[M] : d.push({
                                    index: M,
                                    str: j[M]
                                });
                            var F = c.apply(void 0, C([Y], f));
                            for (M = 0; M < d.length; M++)
                                F.splice(d[M].index, 0, d[M].str);
                            return s ? F : F.join("")
                        }
                        return j = N.tradToSimple(j),
                        c.apply(void 0, C([j], f))
                    };
                    j.spell = function() {
                        for (var j = [], f = 0; f < arguments.length; f++)
                            j[f] = arguments[f];
                        return k.apply(void 0, C([this], j))
                    }
                    ,
                    f.spell = function() {
                        for (var j = [], f = 0; f < arguments.length; f++)
                            j[f] = arguments[f];
                        return k.apply(void 0, j)
                    }
                    ,
                    f._.poly || (f._._reinitSpellPoly = function() {
                        c = f.spell,
                        j.spell = function() {
                            for (var j = [], f = 0; f < arguments.length; f++)
                                j[f] = arguments[f];
                ...
                function(j, f) {
                    var c = f.stroke
                      , k = function(j) {
                        for (var f = [], k = 1; k < arguments.length; k++)
                            f[k - 1] = arguments[k];
                        r.checkArgs("stroke", f, !0);
                        var s = r.has(f, n)
                          , a = r.has(f, i);
                        s || f.push(n);
                        var d = c.apply(void 0, C([j], f));
                        if (a) {
                            if (r.has(f, R))
                                return d;
                            r.has(f, Q);
                            ...
                            for (F = 0; F < d.length; F++)
                                void 0 === d[F] ? d[F] = b[j[F]] : Y.push(F);
                            return r.orderWithLetters(d, j, f, Y)
                        }
                        if (r.has(f, R))
                            return s ? d : r.sumStroke(d);
                        if (r.has(f, Q))
                    ...
                    ,
                    f._.order || (f._._reinitStrokeOrder = function() {
                        c = f.stroke,
                        j.stroke = function() {
                            for (var j = [], f = 0; f < arguments.length; f++)
                                j[f] = arguments[f];
                ...
                f.convertSimpleToTrad = function() {
                    return N.simpleToTrad(this)
                }
                ,
                f.convertSimpleToSpark = function() {
                    return N.simpleToSpark(this)
                }
                ,
                f.convertTradToSimple = function() {
                    return N.tradToSimple(this)
                }
                ,
                f.convertTradToSpark = function() {
                    return N.tradToSpark(this)
                }
                ,
                f.convertSparkToSimple = function() {
                    return N.sparkToSimple(this)
                }
                ,
                f.convertSparkToTrad = function() {
                    return N.sparkToTrad(this)
                }
                ,
                (r = j._).convert = N,
                r.dict.getTradOrders = function() {
                    return b
                }
                ,
        ...
        "object" == typeof window && window.CnChar && (window.CncharTrad = B,
        window.CnChar.use(B));
        f.default = B
    }
    ]).default
